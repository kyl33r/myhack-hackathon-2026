...
export default function InvestorForm() {
  ...
  const [form, setForm] = useState<FormState>({
    fundName: '', contactName: '', contactEmail: '', investorType: '',
    stages: [], industries: [], ticketMin: '', ticketMax: '', thesis: '', portfolio: '',
  })
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitError(null)
    try {
      await submitPartnerProfile({ ...form, partnerType: 'investor' })
      setSubmitted(true)
    } catch (err: unknown) {
      ...
      <main className="container">
        ...
        <div className="card form-card">
          <div className="form-type-badge">
            <span className="actor-tag tag-investor">Investor</span>
          </div>
